...
namespace POS.cr {
    ...
    public class Penjualan : ReportClass {
    ...
    public class CachedPenjualan : Component, ICachedReport {
        
        public CachedPenjualan() {
        }
